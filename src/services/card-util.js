...
export default {
  ...
  getLayerCard (layer: Layer, id: number, arr: Array<Object>, onClick?: Function): CardConfig {
    ...
    const image_url = `/img/resize/400?quality=80&progressive=true&url=/api/screenshot/layer/thumbnail/${layer_id}.jpg`
  ...
  getMapCard (map: Object, id: number, arr: Array<Object>, onClick?: Function): CardConfig {
    const image_url = `/img/resize/400?quality=80&progressive=true&url=/api/screenshot/map/thumbnail/${map.map_id}.jpg`
    return {
  ...
  getGroupCard (group: Object, id: number, arr: Array<Object>, onClick?: Function): CardConfig {
    let image_url
    if (group.hasimage) {
      image_url = `/img/resize/400?url=/group/${group.group_id}/image.png`
    }
    return {
...
|} {
    ...
    if (story.firstimage) {
      ...
      if (!image_url.startsWith('https')) {
        image_url = '/img/resize/400?quality=80&progressive=true&url=' + image_url
      }
    }
