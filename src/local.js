...
var local = {
  ...
  logoWidth: getenv('OMH_LOGO_WIDTH'),
  logoHeight: getenv('OMH_LOGO_HEIGHT'),
  logoSmallWidth: getenv('OMH_LOGO_WIDTH_SMALL'),
  logoSmallHeight: getenv('OMH_LOGO_HEIGHT_SMALL'),
