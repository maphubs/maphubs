exports.up = async (knex) => {
  ...
  await knex.raw(`ALTER TABLE omh.stories DROP CONSTRAINT storiesuserfk`)
  ...
  return knex.raw(
    `ALTER TABLE omh.stories ADD CONSTRAINT storiesuserfk FOREIGN KEY (user_id) REFERENCES nextauth_users (id)`
  )
}
