...
module.exports = {
  ...
  entry: {
    ...
    vendor: ["babel-polyfill", "jquery", "slugify", "react", "react-dom", "materialize-css", "reflux", "debug", "react-notification", "superagent", "bluebird", "classnames", "lodash.isequal", "@turf/bbox", "@turf/meta", "superagent-jsonp", "terraformer", "intl", "moment-timezone", "mapbox-gl", "jsts-es", "mapbox-gl-regex-query", "@mapbox/mapbox-gl-draw", "iconv-lite", "urlencode", "elliptic", "react-slick"],
