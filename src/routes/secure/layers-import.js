...
module.exports = function (app: any) {
  ...
  app.post('/api/import/:group_id/upload', isAuthenticated, multer({dest: local.tempFilePath + '/uploads/'}).single('file'),
    async (req, res) => {
      try {
              ...
              if (maphubsFile.version === 3 && maphubsFile.type === 'map') {
                ...
                knex.transaction(async (trx) => {
                  ...
                  await Promise.mapSeries(keys, async (old_short_id) => {
                    ...
                    maphubsLayer.style = replaceShortID(old_short_id, newId, maphubsLayer.style)
                    // also update the map style
                    mapHubsMap.style = replaceShortID(old_short_id, newId, mapHubsMap.style)
                    // create the layer
