...
export default class Home extends React.Component<Props, State> {
  ...
  render(): JSX.Element {
    ...
    if (storyMode === 'featured') {
      storyCards = _shuffle(
        props.featuredStories.map((s) => cardUtil.getStoryCard(s, t))
      )
    } else if (storyMode === 'popular') {
      storyCards = _shuffle(
        props.popularStories.map((s) => cardUtil.getStoryCard(s, t))
      )
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <CardFilter
                  defaultValue={this.state.storyMode}
                  onChange={(value) => {
                    _this.setState({
                      storyMode: value
                    })
          ...
          >
            ...
            >
              ...
              >
                <CardFilter
                  defaultValue={this.state.layerMode}
                  onChange={(value) => {
                    _this.setState({
                      layerMode: value
                    })
