...
export default class WMSSource extends MapHubsComponent<Props, State> {
  ...
  submit = (model: Object) => {
    ...
    let url = `https://services.digitalglobe.com/mapservice/wmsaccess?bbox={bbox-epsg-4326}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:4326&width=256&height=256&layers=${layers}&connectid=${model.connectid}&COVERAGE_CQL_FILTER=featureId='${model.featureid}'`
