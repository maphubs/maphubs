...
export default class CopyMapModal extends MapHubsComponent<Props, void> {
  ...
  render(){
    return (
      <Modal ref="modal" id="copy-map-modal" dismissible={false} fixedFooter={true}>
        <ModalContent style={{padding: '10px', margin: 0, height: '100%', background: 'white', overflow: 'hidden'}}>
