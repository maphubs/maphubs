...
var Marker = React.createClass({
  ...
  render(){
     ...
     if(this.props.shape === 'SQUARE'){
       markerBackground = (
         <rect x="1" y="1"  width={this.props.width} height={this.props.height}/>
       );
       viewBox = `0 0 50 50`;
     ...
     var icon = '';
     if(this.props.icon){
       let iconWidth: number = 48 * iconScale;
       let iconHeight: number = 48 * iconScale;
       let x: number = 24 - (iconWidth / 2);
       var y: number = 6;
     
       icon = (
         <g fill={this.props.iconFill} width={48} height={48} fillOpacity={this.props.iconFillOpacity} stroke={this.props.iconStroke} strokeWidth={this.props.iconStrokeWidth}>
