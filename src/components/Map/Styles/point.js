// @flow
export default {
  getPointLayers (layer_id: number, shortid: string, color: string, hoverColor: string, interactive: boolean, showBehindBaseMapLabels: boolean): Array<
    ...
    | {|
      ...
      |},
      paint: {|"circle-color": string, "circle-opacity": number|},
      source: string,
      "source-layer": string,
      type: string,
    |}
