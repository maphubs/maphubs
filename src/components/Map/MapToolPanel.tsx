          ...
          >
            <Collapse accordion>
              ...
              <Panel header={t('Find Coordinates')} key='coordinate'>
                <CoordinatePanel
                  zoomToCoordinates={this.props.zoomToCoordinates}
                  t={t}
                />
              </Panel>
              <Panel header={t('Travel Time')} key='traveltime'>
                <IsochronePanel
                  getIsochronePoint={this.props.getIsochronePoint}
                  clearIsochroneLayers={this.props.clearIsochroneLayers}
                  isochroneResult={this.props.isochroneResult}
                  t={t}
                />
              </Panel>
