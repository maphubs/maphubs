...
function oscUpload(req, res, next) {
  var json = null;
  try {
      json = XML.read(req.payload.toString());
  } catch(e) {
    if (e) {
      next('Could not parse XML file');
    }
  }
  var uploadParams = {
    params: {
  ...
  if (!req.params.changesetID) {
    create({payload: {uid: 99, user: 'maphubs'}},
      function(fromCreate) {
...
module.exports = function(app) {
   ...
   *  }
     */
    app.post('/upload/:changesetID?', oscUpload);
};
/*
module.exports = {
